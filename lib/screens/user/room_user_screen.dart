...
class _RoomUserScreenState extends State<RoomUserScreen> {
  ...
  BhRoomProvider? _bhRoomProvider;
  ...
  // ── Số lượng phòng ────────────────────────────────────────────────────────
  Widget _buildRoomCount(BhRoomProvider provider) {
  ...
  Widget _buildRoomCard(BhRoomModel room, BoardingHouseModel? bh) {
    ...
    final statusColor = isWaiting ? const Color(0xFFF59E0B) : AppTheme.successColor;
    final statusLabel = isWaiting ? 'Chờ xác nhận' : 'Đang thuê';
    final statusIcon = isWaiting ? Icons.hourglass_top_rounded : Icons.check_circle;
          ...
          Row(
            children: [
              Container(
                ...
                child: const Icon(Icons.home, color: AppTheme.primary, size: 24),
              ),
